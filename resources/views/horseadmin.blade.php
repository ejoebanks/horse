...
<head>
    <title>Skill Point Education Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
...
<body>
                    ...
                    <div class="col-md-6 hearder-right-agile">
                        <div class="d-flex">
                            ...
                            <div class="login-wthree my-auto">
                                <a href="login.html" class="text-white text-capitalize">login <span class="fas fa-sign-in-alt flash animated infinite"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="password" class="form-control" placeholder="*******" name="Password" id="password2"
                                    required="">
                            </div>
                        </div>
                    </div>
    ...
    <!-- //footer -->
    <!-- js-->
    <script src="{{ asset('js/theme/jquery-2.2.3.min.js') }}"></script>
    <!-- loading-gif Js -->

    <script src="{{ asset('js/theme/modernizr.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('js/theme/custom-select.js') }}"></script>
    <!-- //Multiple select filter using jQuery -->
    <!-- stats counter -->
    <script src="{{ asset('js/theme/counter.js') }}"></script>
    ...
    <script src="{{ asset('js/theme/move-top.js') }}">
    </script>
    <script src="{{ asset('js/theme/easing.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('js/theme/SmoothScroll.min.js') }}"></script>
    <!-- //smooth-scrolling-of-move-up -->
